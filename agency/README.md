...
| 3. Build | `npm run generate -- <lead.json>` | Renders a tailored, polished one-page Finnish site from a small JSON profile (2 template designs, industry color palettes) |
